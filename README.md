...
> 🔹 **CI/CD, JWT — пока не очень понимаю как работают**.  
> Я не притворяюсь, что знаю то, чего не понимаю.  
> Но я **учусь** — и делаю проекты, даже если не всё идеально.

---

## 📦 Парочка проектов которые были сделаны для изучения

### 📂 [TangleApp](https://github.com/Omasy4S/TangleApp)
> **TangleApp** - приложение по вязанию на android, было сделано по просьбе близкого человека, так как аналоги платные.  
> Можно добавлять проекты, счетчики, менять название счетчиков и проектов.  
> Можно добавить виджет, в котором можно будет выбрать нужный счетчик, и прибавлять значения из него.  
> Можно добавить схемы, в виде фото или pdf файлов.  
> Можно сделать расчеты нужной ширины и длины по текущим значениям.

📸 [Скриншот](https://imgur.com/a/fhxMbO2)
